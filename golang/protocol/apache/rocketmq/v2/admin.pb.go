...
const file_apache_rocketmq_v2_admin_proto_rawDesc = "" +
	...
	"\x05Admin\x12i\n" +
	"\x0eChangeLogLevel\x12).apache.rocketmq.v2.ChangeLogLevelRequest\x1a*.apache.rocketmq.v2.ChangeLogLevelResponse\"\x00BJ\n" +
	"\x12apache.rocketmq.v2B\aMQAdminP\x01Z\vrocketmq/v2\xa0\x01\x01\xd8\x01\x01\xf8\x01\x01\xaa\x02\x12Apache.Rocketmq.V2b\x06proto3"
