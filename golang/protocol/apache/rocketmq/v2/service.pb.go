...
const file_apache_rocketmq_v2_service_proto_rawDesc = "" +
	...
	"\rRecallMessage\x12(.apache.rocketmq.v2.RecallMessageRequest\x1a).apache.rocketmq.v2.RecallMessageResponse\"\x00BI\n" +
	"\x12apache.rocketmq.v2B\tMQServiceP\x01Z\vrocketmq/v2\xa0\x01\x01\xd8\x01\x01\xaa\x02\x12Apache.Rocketmq.V2b\x06proto3"
